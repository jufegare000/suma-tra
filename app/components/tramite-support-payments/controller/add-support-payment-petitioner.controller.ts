...
class AddSupportPaymentPetitionerController extends BaseController {
    ...
    protected async executeImpl(req: express.Request, res: express.Response): Promise<void | any> {
        ...
        if (userDto) {
            try {
                ...
                const result = await this.useCase.addSupportPaymentDocumentByPetitioner(requestWithFormats, userDto);
                if (result) {
...
export default new AddSupportPaymentPetitionerController();