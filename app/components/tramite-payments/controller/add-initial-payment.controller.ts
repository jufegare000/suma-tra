...
import { AddInitialPaymentService } from '../service/add-initial-payment.service';
...
class AddInitialPaymentController extends BaseController {

    private useCase: AddInitialPaymentService = new AddInitialPaymentService();
    ...
    protected async executeImpl(req: express.Request, res: express.Response): Promise<void | any> {
        ...
        if (userDto) {
            try {
                ...
                const requestWithFormats: AddInitialPaymentDTO = req.body;
                const result = await this.useCase.addInitialPayment(requestWithFormats, userDto);
                if (result) {
...
export default new AddInitialPaymentController();